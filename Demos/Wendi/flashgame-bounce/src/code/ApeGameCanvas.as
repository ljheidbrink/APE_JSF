...
{                                    
    ...
    public class ApeGameCanvas extends UIComponent 
    {
        // Gameplay constants
        ...
        private var PADDLE_DIST_FROM_BOTTOM:int = 20;
        private var PADDLE_WIDTH:int = 40;
        private var PADDLE_HEIGHT:int = 8;
        private var TIMER_SPEED:Number = 30;
		...
		private var paddle_x:Number;
		private var paddle_y:Number;
		...
		private function setBallSpeed(speed:Number):void {
    		//Set initial ball speed
    		INITIAL_BALL_SPEED = speed;
		}
		private function setPaddleX(xpos:Number):void {
			paddle_x = xpos;
		}
		private function setPaddleY(ypos:Number):void {
			paddle_y = ypos;
		}
		...
		public function startup():void
		{
			...
			ExternalInterface.addCallback("SetBallSpeed", setBallSpeed);
			ExternalInterface.addCallback("SetPaddleX", setPaddleX);
			ExternalInterface.addCallback("SetPaddleY", setPaddleY);

			// display number of lives left & initial ball speed
			ExternalInterface.call("DisplayLives", lives);
		    ExternalInterface.call("DisplaySpeed", INITIAL_BALL_SPEED);
		}
        ...
        public function onTick(evt:TimerEvent):void 
        {
            ...
            if (ball.y - BALL_RADIUS > height)
            {
                ...
                if (lives == 0) {
		            ...
		            {
         	       		var block2del:DisplayObject = blocks[i];
                		if (block2del == null) continue;
	                    removeChild(block2del);
	                    blocks[i] = null;
    				}            	
                	Application.application.currentState = "GameOver";
                }
                resetBall();
               	ExternalInterface.call("DisplayLives", lives);
            }
